...
class AclEntries
{
    ...
    /**
     * @var \MRusso\LibBundle\Entity\AclObjectIdentities
     *
     * @ORM\ManyToOne(targetEntity="MRusso\LibBundle\Entity\AclObjectIdentities")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \MRusso\LibBundle\Entity\AclSecurityIdentities
     *
     * @ORM\ManyToOne(targetEntity="MRusso\LibBundle\Entity\AclSecurityIdentities")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \MRusso\LibBundle\Entity\AclClasses
     *
     * @ORM\ManyToOne(targetEntity="MRusso\LibBundle\Entity\AclClasses")
     * @ORM\JoinColumns({
     ...
     * Set objectentity
     *
     * @param \MRusso\LibBundle\Entity\AclObjectIdentities $objectentity
     *
     * @return AclEntries
     */
    public function setObjectentity(\MRusso\LibBundle\Entity\AclObjectIdentities $objectentity = null)
    {
     ...
     * Get objectentity
     *
     * @return \MRusso\LibBundle\Entity\AclObjectIdentities
     */
     ...
     * Set securityentity
     *
     * @param \MRusso\LibBundle\Entity\AclSecurityIdentities $securityentity
     *
     * @return AclEntries
     */
    public function setSecurityentity(\MRusso\LibBundle\Entity\AclSecurityIdentities $securityentity = null)
    {
     ...
     * Get securityentity
     *
     * @return \MRusso\LibBundle\Entity\AclSecurityIdentities
     */
     ...
     * Set class
     *
     * @param \MRusso\LibBundle\Entity\AclClasses $class
     *
     * @return AclEntries
     */
    public function setClass(\MRusso\LibBundle\Entity\AclClasses $class = null)
    {
        $this->class = $class;
     ...
     * Get class
     *
     * @return \MRusso\LibBundle\Entity\AclClasses
     */
