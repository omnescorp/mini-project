...
class AclObjectIdentities
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="MRusso\LibBundle\Entity\AclObjectIdentities", inversedBy="objectentity")
     ...
     *
     * @param \MRusso\LibBundle\Entity\AclObjectIdentities $parentObjectentity
     *
     * @return AclObjectIdentities
     */
    public function setParentObjectentity(\MRusso\LibBundle\Entity\AclObjectIdentities $parentObjectentity = null)
    {
     ...
     * Add ancestor
     *
     * @param \MRusso\LibBundle\Entity\AclObjectIdentities $ancestor
     *
     * @return AclObjectIdentities
     */
    public function addAncestor(\MRusso\LibBundle\Entity\AclObjectIdentities $ancestor)
    {
     ...
     * @param \MRusso\LibBundle\Entity\AclObjectIdentities $ancestor
     */
    public function removeAncestor(\MRusso\LibBundle\Entity\AclObjectIdentities $ancestor)
    {
